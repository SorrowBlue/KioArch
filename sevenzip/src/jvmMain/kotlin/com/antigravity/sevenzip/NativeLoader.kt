...
internal object NativeLoader {
    ...
    fun load() {
        ...
        try {
            ...
            val resourcePath = "/natives/$dir/sevenzip.$ext"
            ...
            val tempFile = File.createTempFile("libsevenzip", ".$ext")
            ...
            throw UnsatisfiedLinkError("Failed to load native 7-Zip library: ${e.message}").apply {
                initCause(e)
            }
        }
    }
