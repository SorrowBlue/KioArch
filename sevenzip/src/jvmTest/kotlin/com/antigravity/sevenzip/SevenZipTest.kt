...
class SevenZipTest {
    ...
    fun testInvalidArchiveThrowsException() {
        ...
        assertFailsWith<IllegalArgumentException> {
            SevenZipMultiplatform.createReader(invalidData).use { reader ->
                reader.getEntries()
            }
        }
    }
    ...
    fun testRealExtraction() {
        ...
        if (!file.exists()) {
            file = java.io.File("sevenzip/src/jvmTest/resources/test.7z")
        }
        assertTrue(file.exists(), "test.7z does not exist (tried: src/jvmTest/resources/test.7z and sevenzip/src/jvmTest/resources/test.7z)")
